...
HD_PWD='/home/justin/vivado_projects/OLED_LED_BUTTON/OLED_LED_BUTTON.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log OLED_LED_BUTTON_design_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source OLED_LED_BUTTON_design_wrapper.tcl
